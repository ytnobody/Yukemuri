  ...
  return (
    <div className="container">
      <div className="text-center mb-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Yukemuri!</h1>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Complete guide to all Yukemuri APIs including PWA, notifications, QR codes, and
              storage management.
            </p>
            <div className="mt-3 text-blue-500 text-sm font-medium">Read Documentation →</div>
          </a>
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Real-world component examples showing how to build complete features with Yukemuri
              framework.
            </p>
            <div className="mt-3 text-green-500 text-sm font-medium">View Examples →</div>
          </a>
        </div>
      </div>
      ...
      <div className="text-center">
        <p className="text-gray-600">
          Start building your PWA by editing files in{" "}
  ...
  const requestNotificationPermission = async () => {
    ...
    try {
      ...
      const confirmRequest = confirm(
        'We will request notification permission. Please select "Allow" in the browser dialog.'
      )
      if (!confirmRequest) {
      ...
      if (permission === "granted") {
        ...
        alert(
          '❌ Notifications denied. Please enable notifications in browser settings.\n\nSteps:\n1. Click the 🔒 icon in the address bar\n2. Change "Notifications" to "Allow"\n3. Reload the page'
        )
      } else {
      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-2">
            Installable: {isInstallable ? "✅ Yes" : "❌ No"} | Installed:{" "}
            {isInstalled ? "✅ Yes" : "❌ No"}
          </p>
          <button
            onClick={handleInstall}
            className={`px-4 py-2 rounded text-white ${
              isInstallable ? "bg-green-500 hover:bg-green-600" : "bg-gray-400 cursor-not-allowed"
            }`}
        ...
        <div>
          ...
          {notificationPermission === "denied" && (
            <p className="text-xs text-red-600 mt-2">
              ⚠️ Notifications are denied. Please enable notifications in browser settings (click the
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded text-xs">
            ...
            <button
              onClick={() => {
                ...
                alert(
                  "Diagnostic information has been output to the console. Press F12 and check the Console tab."
                )
              }}
