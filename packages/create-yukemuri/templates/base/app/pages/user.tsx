    ...
    return (
      <div className="container">
        <div className="text-center py-8">
          ...
          <a href="/users" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
            Back to Users
          </a>
        </div>
      </div>
    ...
    <div className="container">
      <div className="mb-8">
        <nav className="text-sm text-gray-500 mb-4">
          ...
          <a href="/users" className="hover:text-gray-700">
            Users
          </a>
          <span className="mx-2">/</span>
        ...
        <p className="text-xl text-gray-600">Information for user #{user.id}</p>
      </div>
