        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>
                <a href="#pwa-api" className="text-blue-600 hover:underline">
                  PWA Management
                </a>
              </li>
              <li>
                <a href="#notifications-api" className="text-blue-600 hover:underline">
                  Notifications
                </a>
              </li>
              <li>
                <a href="#qr-api" className="text-blue-600 hover:underline">
                  QR Code Generation
                </a>
              </li>
              <li>
                <a href="#storage-api" className="text-blue-600 hover:underline">
                  Storage Management
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li>
                <a href="#typescript" className="text-blue-600 hover:underline">
                  TypeScript Types
                </a>
              </li>
            </ul>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="bg-white p-3 rounded text-sm">
              <pre>
                <code>{`// Install the app
await yu.pwa.install()

// Check status
yu.pwa.isInstalled()`}</code>
              </pre>
            </div>
          </div>
...
// Send notification
await yu.notifications.sendNotification('Hello!')`}</code>
              </pre>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.pwa.install(): Promise&lt;boolean&gt;</code>
            </h3>
  ...
  try {
    ...
    console.error('Installation failed:', error)
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.pwa.getStatus(): PWAStatus</code>
            </h3>
  ...
  notificationPermission: status.notificationPermission
      ...
      <section id="notifications-api" className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.notifications.sendNotification(title, options)</code>
            </h3>
...
await yu.notifications.sendNotification('Order Complete', {
  ...
  data: { orderId: 1234, action: 'view' }
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.notifications.requestPermission()</code>
            </h3>
    ...
    icon: '/icons/icon-192x192.png'
      ...
      <section id="qr-api" className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.qr.generate(value, options)</code>
            </h3>
...
const customQR = await yu.qr.generate('Hello World', {
  ...
  errorCorrectionLevel: 'H'
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.qr.getCurrentURL(options)</code>
            </h3>
...
showQRModal(pageQR)`}</code>
      ...
      <section id="storage-api" className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.storage.local&lt;T&gt;(key, defaultValue, options)</code>
            </h3>
            <p className="text-gray-600 mb-4">
              Creates a localStorage controller with type safety.
            </p>
...
const unsubscribe = settingsStorage.subscribe(settings => {
  console.log('Settings changed:', settings)
          ...
          <div className="border rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-3">
              <code>yu.storage.persistent&lt;T&gt;(key, defaultValue, options)</code>
            </h3>
            <p className="text-gray-600 mb-4">
...
export default function MyComponent() {
  ...
  StorageController
      ...
      <footer className="border-t pt-8 mt-12 text-center text-gray-500">
        <p className="mb-4">Built with ♨️ Yukemuri Framework</p>
        <div className="space-x-4 text-sm">
          ...
          <a href="https://github.com/ytnobody/Yukemuri" className="text-blue-600 hover:underline">
            GitHub
          </a>
        </div>
      </footer>
