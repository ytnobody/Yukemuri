...
export default defineConfig({
  ...
  safelist: [
    // 重要なスタイルを強制的に生成
    'text-8xl', 'text-4xl', 'text-2xl', 'text-xl', 'text-lg',
    'font-bold', 'font-semibold', 'font-medium',
    'text-center', 'text-gray-900', 'text-gray-600', 'text-primary-600',
    'mb-4', 'mb-6', 'mb-8', 'container', 'card',
    'btn-primary', 'btn-danger', 'btn-secondary',
    'bg-gray-50', 'min-h-screen', 'flex', 'gap-3', 'space-y-2', 'space-y-4'
  ]
})