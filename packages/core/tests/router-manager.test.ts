...
describe("RouterManager", () => {
  ...
  describe("complex routing scenarios", () => {
    ...
    it("should handle numeric parameter values", () => {
      const params = router.extractParams("/api/:version/users/:id", "/api/v1/users/123")
    ...
    it("should handle multi-segment catch-all", () => {
      const params = router.extractParams("/files/*filepath", "/files/documents/2024/report.pdf")
